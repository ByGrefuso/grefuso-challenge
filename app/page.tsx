  ...
  return (
    <main className="site-shell home-page">
      <header className="topbar">
        ...
        <nav><Link href="/">Inicio</Link><Link href="/challenge/2026">Challenge 2026</Link><a href="#events">Eventos</a></nav>
      </header>
      <section className="home-hero">
        <div className="eyebrow">BYGREFUSO · ESPORTS & COMMUNITY</div>
        <h1>GREFUSO<br /><span>EVENTS</span></h1>
        <p>Competiciones, retos y eventos creados para la comunidad.</p>
      </section>
      <section id="events" className="section events-section">
        <div className="section-head"><span>01</span><div><div className="eyebrow">EVENTOS</div><h2>EL ARCHIVO</h2></div></div>
      ...
      <section className="coming-section"><div className="coming-label">NEXT EVENT</div><h2>GREFUSO CUP</h2><p>Estamos preparando algo grande.</p><span>PRÓXIMAMENTE</span></section>
