...
export default function Home() {
  ...
  return (
    <main className="challenge-page">
      ...
      <section id="clasificacion" className="simple-section">
        <span className="section-number">03</span>
        <div>
          <h2>CLASIFICACIÓN</h2>
          <p>
            La clasificación del challenge se mostrará aquí y posteriormente
            se conectará con los datos de Riot Games.
          </p>
        </div>
      </section>
