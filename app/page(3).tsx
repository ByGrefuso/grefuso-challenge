...
const PARTICIPANTS = [
  ...
  { name: "cris", riotId: "Calm Smurf#EUW", platform: "twitch", channel: "crisbalde_" },
  ...
  { name: "Fabi", riotId: "icecoffeeweb#432", platform: null, channel: null },
  { name: "hipérbole", riotId: "Anworthy#EUW", platform: null, channel: null },
  { name: "aitor", riotId: "SexyBambino#EUW", platform: "twitch", channel: "DragonSniper555" },
  { name: "Luewer", riotId: "nitte#88776", platform: "twitch", channel: "luewer18" },
] as const;

const streamerLabels: Record<string, string[]> = {
  bygrefuso: ["STREAM"],
  sallanman_cat: ["PRO", "STREAM"],
  crisbalde_: ["STREAM"],
  yuuki26_: ["STREAM"],
  orewarulo: ["STREAM"],
  fardos_31: ["STREAM"],
...
export default function Home() {
  ...
  const orderedStreamers = [...streamers].sort((a, b) => {
    if (a.channel === "bygrefuso") return -1;
    if (b.channel === "bygrefuso") return 1;
    if (a.live !== b.live) return a.live ? -1 : 1;
    return a.displayName.localeCompare(b.displayName, "es");
  });
